...
// Fetch game details
  const fetchGameDetails = async (gameId, bonusId) => {
    try {
      console.log("Fetching details for gameId:", gameId, "and bonusId:", bonusId);
      ...
      setError("Failed to fetch game details: " + (error.response ? error.response.data.error : error.message));
    } finally {
      setLoading(false);
    }
  };
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <div className="flex space-x-4">
                    <button
                      ...
                      className={`flex items-center justify-center w-1/2 py-2 border rounded-md ${selectedDevice === "Mobile"
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center w-1/2 py-2 border rounded-md ${selectedDevice === "Desktop"
                          ? "bg-blue-500 text-white"
                          : "bg-white text-gray-700"
                        }`}
                    >
                ...
                <div>
                  ...
                  >
                    ...
                    {Array.isArray(bonus) && bonus.map((b) => (
